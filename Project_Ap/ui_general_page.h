/********************************************************************************
** Form generated from reading UI file 'general_page.ui'
**
...
#ifndef UI_GENERAL_PAGE_H
#define UI_GENERAL_PAGE_H
...
public:
    ...
    void setupUi(QDialog *General_page)
    {
        ...
        formLayoutWidget->setGeometry(QRect(100, 100, 511, 361));
    ...
    void retranslateUi(QDialog *General_page)
    {
        ...
        label_11->setText(QCoreApplication::translate("General_page", "Create a Team :", nullptr));
        pushButton_11->setText(QCoreApplication::translate("General_page", "Create", nullptr));
    } // retranslateUi
